    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-24 md:pb-32 section-padding">
        ...
        >
          ...
          <p className="text-base md:text-lg font-body font-light text-silver max-w-2xl mb-10 leading-relaxed">
            Advanced AV, IT and Connectivity Systems for the World's Most
            Exceptional Yachts.
          </p>
          <a
            href="#services"
